...
(function($, window){
	...
	window.onload = function() {
		...
		//调整沉浸式状态栏的header的高度
		function changeStatusBarHeight () {
			if (plus.navigator.isImmersedStatusbar()) {	
				let commonHeader = $('.common-header')
				if(!commonHeader.length) return false;
				$('.common-header')[0].style.paddingTop = plus.navigator.getStatusbarHeight() + 'px'					
			}
		}
	}
...
function RemReturnPixel (rem) {
//	1.3rem    rem = 1.3 *  document.documentElement.clientWidth / 3.75 
	return ( document.documentElement.clientWidth / 3.75 ) * rem + 'px'
}

function setTopByHeight (height) {
